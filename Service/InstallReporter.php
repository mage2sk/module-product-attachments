<?php
/**
 * Standalone install + heartbeat reporter for Panth_ProductAttachments.
 *
...
namespace Panth\ProductAttachments\Service;
...
class InstallReporter
{
    ...
    public const MAGENTO_MODULE = 'Panth_ProductAttachments';

    /** Composer package name reported to the receiver. */
    public const COMPOSER_PACKAGE = 'mage2kishan/module-product-attachments';
